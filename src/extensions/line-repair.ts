...
const ACTION_VERBS_AFTER_THUMMA: readonly string[] = [
  "يخرج", "يدخل", "ينهض", "يلتفت", "يرفع", "يفتح", "يغلق",
  "يمشي", "يجلس", "يقف", "ينظر", "يشير", "يضع", "يسحب",
  "يمسك", "يأخذ", "يرمي", "يركض", "يقفز", "يسقط", "يصعد",
  "ينزل", "يتحرك", "يتوقف", "يبتعد", "يقترب", "يتراجع",
  "يهرب", "يعود", "يتقدم", "يدور", "يستدير", "يتجه",
  "تخرج", "تدخل", "تنهض", "تلتفت", "ترفع", "تفتح", "تغلق",
  "تمشي", "تجلس", "تقف", "تنظر", "تشير", "تضع", "تسحب",
];
